...
import BoldHero from "./hero/BoldHero";
...
export default function Bold( {page}: Readonly<PublicStyleProps>) {
  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      {/* HERO BACKGROUND */}
      <div className=" absolute inset-x-0 top-0 h-fit overflow-hidden rounded-b-[4rem] shadow-[0_8px_6px_-4px_rgba(0,0,0,0.25)] -z-10 "
        style={{
